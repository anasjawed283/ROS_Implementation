...
import sys
import rospy
from new_pkg.srv import ConvertMetresToFeet, ConvertMetresToFeetRequest, ConvertMetresToFeetResponse
...
def metres_to_feet_client(x):
    ...
    try:
        ...
        #rint("I only got here AFTER the service call was completed!")
...
if __name__ == "__main__":
    ...
    dist_metres = int(input("Enter value: "))
    ...
    if(not service_response.success):
        ...
        rospy.loginfo("%4.2f(m) = %4.2f feet"%(dist_metres,
